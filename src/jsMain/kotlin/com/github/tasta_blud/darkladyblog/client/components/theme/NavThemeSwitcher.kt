...
class NavThemeSwitcher : SimplePanel() {
    private val sizeIcon: String = "38px"
    ...
    init {
        ...
        div(className = "dropdown") {
            button(
                className = "nav-link py-0 px-0 px-lg-2 dropdown-toggle d-flex align-items-center",
                text = "",
                ...
                setAttribute("data-bs-display", "static")
                setAttribute("aria-label", "Toggle theme (auto)")
                svgSpan(
                    className = "bi my-0 theme-icon-active",
                    svg = "<svg class=\"bi my-0 theme-icon-active\" width=\"$sizeIcon\" height=\"$sizeIcon\"><use href=\"#circle-half\"></use></svg>"
                )
...
fun Container.navThemeSwitcher(): NavThemeSwitcher =
    NavThemeSwitcher().also { add(it) }
